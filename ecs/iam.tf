...
resource "aws_iam_role_policy_attachment" "ecs_task_iam_role_ecr_readonly" {
  role       = aws_iam_role.ecs_task_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryReadOnly"
}


resource "aws_iam_role_policy_attachment" "ecs_task_iam_role_ecs_task_exec" {
  role       = aws_iam_role.ecs_task_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonECSTaskExecutionRolePolicy"
}

resource "aws_iam_role_policy_attachment" "ecs_task_iam_role_ssm_readonly" {
  role       = aws_iam_role.ecs_task_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMReadOnlyAccess"
}
